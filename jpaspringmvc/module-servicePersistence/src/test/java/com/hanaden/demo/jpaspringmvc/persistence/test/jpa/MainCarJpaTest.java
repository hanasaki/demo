package com.hanaden.demo.jpaspringmvc.persistence.test.jpa;
...
@ContextConfiguration(locations = {
    "/conf/spring/test/spring-BasicTestJpa.xml"
})
@Transactional(value = "beanTransactionManagerBasicTest")
@TransactionConfiguration(defaultRollback = true,
transactionManager = "beanTransactionManagerBasicTest")
public class MainCarJpaTest {

    @Resource(name = "beanCarDao")
    protected CarDao carDao;
    private static final Logger logger = Logger.getLogger(MainCarJpaTest.class);
    protected long pk;
